...
res.render('index', { title: 'Butterfly App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Butterfly App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Butterfly App Login', user : req.user });
  });
